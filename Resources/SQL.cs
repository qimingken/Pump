...
namespace Crane
{
    class SQL
    {
        ...
        public void DelCrane()
        {
            ...
            string delcrane_check = "delete from crane_check where crane_info ='" + Global.crane_info + "'";
            SqlCommand _delcrane_check = new SqlCommand(delcrane_check, Conn);
            _delcrane_check.ExecuteNonQuery();
